...
#include <iostream>
#include <fstream>
#include <NoneExistingPlayerFile.h> //header file for the exception handling
using namespace std;
////////////////////////////////////////////////////////////////////////////////
Player::Player()
{
...
Player::AskInfo( Player & p)
{
  ...
  while ( !f.eof()  )
  {
   ...
   // if ( line == "#player")
	...
	catch (NoneExistingPlayerFile &noneExistingPlayerFile)
		{
		cout << "Exception Occurred :";
			<<noneExistingPlayerFile.what() <<endl;
		
		}
	cout << "create a file starting by #player and try again";
